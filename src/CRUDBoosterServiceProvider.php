<?php namespace niikhsan\satusehat;

use niikhsan\satusehat\commands\CrudboosterVersionCommand;
use niikhsan\satusehat\commands\Mailqueues;
use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\ServiceProvider;
use niikhsan\satusehat\commands\CrudboosterInstallationCommand;
use niikhsan\satusehat\commands\CrudboosterUpdateCommand;
...
class CRUDBoosterServiceProvider extends ServiceProvider
{
    ...
    {                                   
        ...
        $loader->alias('CRUDBooster', 'niikhsan\satusehat\helpers\CRUDBooster');
        $loader->alias('CB', 'niikhsan\satusehat\helpers\CB');
    }

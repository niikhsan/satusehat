...
class CrudboosterUpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'satusehat:update';
     ...
     * @var string
     */
    protected $description = 'satusehat Update Command';
    ...
    public function handle()
    {
        ...
        $this->info('Publishing satusehat needs file...');
        ...
        $configLFMModified = str_replace("['web','auth']", "['web','\niikhsan\satusehat\middlewares\CBBackend']", $configLFM);

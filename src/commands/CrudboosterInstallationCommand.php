...
class CrudboosterInstallationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'satusehat:install';
     ...
     * @var string
     */
    protected $description = 'satusehat Installation Command';
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $this->info('Publishing satusehat assets...');
            $this->call('vendor:publish', ['--provider' => 'niikhsan\satusehat\CRUDBoosterServiceProvider']);
            ...
            $this->info('Installing satusehat Is Completed ! Thank You :)');
        } else {
...
#                                                                                                                       
			");
        $this->info('--------- :===: Thanks for choosing satusehat :==: ---------------');
        $this->info('====================================================================');
    }
    ...
    {
        $this->info('--');
        $this->info('Homepage : not set');
        $this->info('Github : https://github.com/niikhsan/satusehat');
        $this->info('Documentation : not set');
        $this->info('====================================================================');
        if ($success == true) {
            $this->info('------------------- :===: Completed !! :===: ------------------------');
        } else {
